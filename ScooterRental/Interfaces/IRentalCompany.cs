namespace ScooterRental.Interfaces
{
    public interface IRentalCompany
    {
        ...
        /// Income report.
        /// </summary>
        /// <param name="reportYear">Year of the report. Sum all years if value is not set.</param>
        ...
        decimal CalculateIncome(int? reportYear, bool includeNotCompletedRentals);
    }
}